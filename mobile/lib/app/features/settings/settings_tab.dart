        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                const _SectionTitle(kicker: 'Theme', title: 'App and generator defaults'),
                const SizedBox(height: 12),
                DropdownButtonFormField<String>(
                  key: ValueKey<String>('settings-app-theme-${_settings.appThemeId}'),
                ...
                const SizedBox(height: 12),
                DropdownButtonFormField<String>(
                  key: ValueKey<String>('settings-generator-theme-${_settings.generatorThemeId}'),
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      ...
                      _updateSetting(_settings.copyWith(generatorThemeId: value));
                    }
                  },
                ),
                const SizedBox(height: 12),
                DropdownButtonFormField<String>(
                  key: ValueKey<String>('settings-frame-${_settings.defaultFrameId}'),
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                const _SectionTitle(kicker: 'Scanner', title: 'Camera and detection settings'),
                const SizedBox(height: 12),
                DropdownButtonFormField<String>(
                  key: ValueKey<String>('settings-focus-${_settings.focusProfile}'),
                  ...
                  onChanged: (value) {
                    if (value != null) _updateSetting(_settings.copyWith(focusProfile: value));
                  },
                ),
                const SizedBox(height: 12),
                SwitchListTile.adaptive(
                  ...
                  onChanged: (value) => _updateSetting(_settings.copyWith(autoZoom: value)),
                ),
                SwitchListTile.adaptive(
                  contentPadding: EdgeInsets.zero,
                  ...
                  onChanged: (value) => _updateSetting(_settings.copyWith(preferFrontCamera: value)),
                ),
                SwitchListTile.adaptive(
                  contentPadding: EdgeInsets.zero,
                  ...
                  onChanged: (value) => _updateSetting(_settings.copyWith(hapticsEnabled: value)),
                ),
              ],
            ),
          ),
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                const _SectionTitle(kicker: 'Storage', title: 'Save folder and gallery controls'),
                const SizedBox(height: 12),
                Text('Current save folder: ${_settings.saveDirectoryPath}'),
                const SizedBox(height: 12),
                FilledButton.icon(onPressed: _pickSaveDirectory, icon: const Icon(Icons.folder_open), label: const Text('Change Save Folder')),
              ],
            ),
          ),
        ),
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                const _SectionTitle(kicker: 'History', title: 'Limit and cleanup'),
                const SizedBox(height: 8),
                Text('Stored scans: ${_history.length} / ${_settings.historyLimit}'),
                Slider(
                  min: 10,
                  max: 1000,
                  divisions: 99,
                  ...
                  onChanged: (value) async {
                    ...
                    await _updateSetting(_settings.copyWith(historyLimit: nextLimit));
                    await _persistHistory();
                  },
                ),
                OutlinedButton.icon(onPressed: _clearHistory, icon: const Icon(Icons.delete_sweep_outlined), label: const Text('Clear Scan History')),
              ],
            ),
          ),
        ),
